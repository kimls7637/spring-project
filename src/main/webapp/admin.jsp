			...
			<nav class="navbar p-0 fixed-top d-flex flex-row">
				<div
					...
					<a class="navbar-brand brand-logo-mini" href="admin.do"
						style="color: white; font-weight: 600;">A</a>
				</div>
				<div
					...
					<div class="row">
						<div class="col-xl-3 col-sm-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body"
									...
									<div style="font-size: 20px;">총회원</div>
									<div style="display: flex; align-items: end; font-size: 40px;">${allMember.memberCnt}
									</div>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-sm-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body"
									style="display: flex; justify-content: space-between;">
									<div style="font-size: 20px;">총게시글</div>
									<div style="display: flex; align-items: end; font-size: 40px;">${allBoard.boardCnt}
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<canvas id="pieChart" data-cnt="${boardCntList}"
										data-grade='["커뮤니티", "꿀팁공유", "공지사항"]'
										style="height: 252px; display: block; width: 504px;"
										width="1008" height="504" class="chartjs-render-monitor"></canvas>
								</div>
							</div>
						</div>
						<!--  chart-->
						<div class="col-lg-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<canvas id="barChart" data-cnt="${memberCntList}"
										data-cate='["씨앗", "새싹", "열매", "나무"]' style="height: 230px"></canvas>
								</div>
							</div>
						</div>
						<!-- chart -->
