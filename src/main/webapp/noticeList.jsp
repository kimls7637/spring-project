				...
				<div class="row" style="display: flow-root;">
					<div class="card text-center mb-5">
							...
							<div class="blog-media">
								<div class="text-left">
									<h4 style="font-weight: bold;">
										<spring:message code="message.noticeList.title" />
									</h4>
									<p style="">
										<spring:message code="message.noticeList.content" />
									</p>
								</div>
								...
								<c:if test="${member.mNickname == '관리자'}">
									<div class="  loginHere">
										<a
											...
											href="insertBoard.do?bCate=공지사항"
											style="width: 15%; background-color: #a0ba83;"><svg
                                 ...
                                 <path
											...
											class="inline text-sm font-medium hover:no-underline sm:leading-5"><spring:message
													code="message.noticeList.write" /></span></a>
									</div>
								</c:if>
						...
						<div class="list" style="text-align: right;">
							<a href="recent.do?bCate=공지사항"><button id="recent"
									style="color: black; text-decoration: none; outline: none;">
									<spring:message code="message.noticeList.recentOrder" />
								</button></a> / <a href="hit.do?bCate=공지사항"><button id="hit"
									style="color: black; text-decoration: none; outline: none;">
									<spring:message code="message.noticeList.viewOrder" />
								</button></a>
						</div>
						<hr>
						...
						<div
							...
							<span
								style="float: left; font-weight: 700; width: 8%; padding-left: 24px;"><spring:message
									code="message.noticeList.num" /></span> <span
								style="float: left; font-weight: 700; width: 45%; padding-left: 30px;"><spring:message
									code="message.noticeList.title2" /></span> <span
								style="float: left; font-weight: 700; width: 12%;"><spring:message
									code="message.noticeList.comment" /></span> <span
								style="float: left; font-weight: 700; padding-left: 20px;"><spring:message
									code="message.noticeList.writer" /></span> <span
								style="float: left; font-weight: 700; width: 11%; padding-left: 33px;"><spring:message
									code="message.noticeList.view" /></span> <span
								style="font-weight: 700; width: 15%; padding-left: 20px;"><spring:message
									code="message.noticeList.date" /></span>
						</div>
