	...
	<div id="__next" data-reactroot="">
		<div class="mt-20 flex justify-center px-6 pb-16 sm:mt-32 sm:px-0">
			<div class="w-full max-w-md" style="margin-top: 150px;">
				<!-- 메인 로고 -->
				<div
					style="width: 25%; display: block; margin: auto; margin-bottom: 40px;">
					<a class="navbar-brand" href="main.do"><img class="acense"
						src="assets/imgs/ace.png" alt="메인로고"></a>
				</div>
				...
				<p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400"
					style="margin-top: 20px; font-size: 25px;">${member.mName}님의
					아이디는 ${member.id}입니다.</p>
					...
					<div class="relative my-7">
						...
						<div class="relative flex justify-center text-sm">
							<span class="bg-white px-2 text-gray-500 dark:bg-gray-800"
								style="font-size: 15px;">ACENSE</span>
						</div>
					</div>

					<div
						style="border: 1px solid black; border-radius: 5px; margin-top: 40px; margin-bottom: 40px;">
						<a href="main.do"><button type="submit"
								style="color: black;"
								class="flex w-full justify-center rounded-md border border-transparent bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-400 focus:outline-none disabled:bg-blue-500 disabled:opacity-40">메인으로
								돌아가기</button></a>
						<!-- 버튼으로 링크이동
